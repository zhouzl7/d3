...
class PCA:
    ...
    def transform(self, target_dim):
        ...
        decreasing_index = np.argsort(-self.cov_eigenvalues)[:target_dim]
        top_k_eigenvalues = self.cov_eigenvalues[decreasing_index]
        top_k_FV = self.cov_feature_vector[:, decreasing_index]
